...
namespace AppleEShop.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public CommentsController(AppleEShopContext context)
        {
            _context = context;
        }
        ...
        {
            var AppleEShopContext = _context.Comment.Include(c => c.Product).Include(c => c.User);
            return View(await AppleEShopContext.ToListAsync());
        }
