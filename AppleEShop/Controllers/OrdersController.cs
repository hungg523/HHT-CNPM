...
namespace AppleEShop.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(AppleEShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(PaymentModel? cart)
        {
            ...
            var AppleEShopContext = _context.Order.Include(o => o.Delivery).Include(o => o.Districts).Include(o => o.Provinces).Include(o => o.User).Include(o => o.Wards);
            return View(model);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppleEShopContext.Order'  is null.");
            }
            var order = await _context.Order.FindAsync(id);
            if (order != null)
            {
