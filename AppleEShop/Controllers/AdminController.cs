...
namespace AppleEShop.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(AppleEShopContext context, ICategoryRepository categoryRepository)
        {
            _context = context;
        ...
        public async Task<IActionResult> CategoriesIndex()
        {
            return _context.Category != null ?
                        ...
                        Problem("Entity set 'AppleEShopContext.Category'  is null.");
        }
        [Authorize(Roles = "Administrator")]
        ...
        public async Task<IActionResult> CategoriesDelete(int id)
        {
            ...
            {
                return Problem("Entity set 'AppleEShopContext.Category'  is null.");
            }
            var category = await _context.Category.FindAsync(id);
            if (category != null)
            {
        ...
        {
            var AppleEShopContext = _context.Product.Include(p => p.Category);
            var pageSize = 10; // Cập nhật kích thước trang là 10
            var total = AppleEShopContext.Count();
            ViewBag.total = total;
            ...
            var pagedProducts = await AppleEShopContext.Skip((pageNumber - 1) * pageSize).Take(pageSize).ToListAsync();
        ...
        public async Task<IActionResult> ProductsDeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppleEShopContext.Product'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {
        ...
        public async Task<IActionResult> UsersIndex()
        {
            ...
            return user != null ?
                        ...
                        Problem("Entity set 'AppleEShopContext.User'  is null.");
        }
        ...
        public async Task<IActionResult> UsersDeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppleEShopContext.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
        ...
        {
            var AppleEShopContext = _context.Comment
                .Include(p => p.Product)
                .Include(p => p.User)
            ...
            ViewBag.page = page;
            ViewBag.pageNumber = pageNumber;
            var pagedComments = await AppleEShopContext.Skip((pageNumber - 1) * pageSize).Take(pageSize).ToListAsync();
        ...
        public async Task<IActionResult> CommentDeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppleEShopContext.Comment'  is null.");
            }
